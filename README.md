...
<br><br>
[![My Skills](https://skillicons.dev/icons?i=github,git,linux,html,css,js,ts,react,redux,nextjs,tailwind,bootstrap,sass,nodejs,express,figma,mongodb,jest,nestjs,xd,postman,webpack,codepen,graphql,cloudflare,materialui,netlify,npm,vite,vercel,yarn,wordpress,figma,materialui,vim,vue,nuxtjs,visualstudio,vscode,stackoverflow,c,cs,cpp,babel,dotnet,mysql,&perline=12)](https://skillicons.dev)
<br><br>
